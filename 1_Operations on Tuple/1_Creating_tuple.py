#2. Tuple data-type : tuple is another collection data type, it consist of element of similar or different data type.
# element are enclosed within circle brackets and separeted by commas.
# tuple are generally immutable i.e. they can't be modified or changed.
# Tuple = (val1, val2, val3, - - - ,valn)

#1]. Creating and Declaring a Tuple 
''' Syntax :
