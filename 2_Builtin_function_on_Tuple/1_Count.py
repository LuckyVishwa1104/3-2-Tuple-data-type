#5]. Different methods or builtin function :   there are different methods or builtin function that can be performed on tuple.
#1). Count() - return the max. countnof particular elem.
